...
def get_3d_sincos_pos_embed(
    ...
    grid_h, grid_d, grid_w = np.meshgrid(grid_h, grid_d, grid_w)  # order of meshgrid is very important for indexing as [d,h,w]??? SHOULD IT BE [h,d,w]? MAYBE JUST WRONG COMMENT?
    ...
    pos_embed = np.concatenate([emb_d, emb_h, emb_w], axis=1) # ??? DO WE NEED TO CHANGE THIS ORDER?
